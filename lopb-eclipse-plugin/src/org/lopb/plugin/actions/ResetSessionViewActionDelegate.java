...
/**
 * The Class ResetSessionViewActionDelegate.
 */
public class ResetSessionViewActionDelegate implements IViewActionDelegate {

	/** The Constant log. */
	private static final Log log = LogFactory.getLog(ResetSessionViewActionDelegate.class);
